      ...
      >
        ...
        <Form.Group className="mb-3" controlId="formGridAddress1">
          ...
          <Form.Control
            ...
            {...state.newOrder.bind("street_number")}
          />
        </Form.Group>
    ...
    <div className="d-flex flex-column" style={{ minHeight: "100vh" }}>
      ...
      >
        <Row>
          <Col>
            <h4>
              Du kan tyvärr inte avsluta ditt köp just nu, försök igen när du är
              onilne.
            </h4>
